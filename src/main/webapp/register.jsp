...
<div data-v-676ecf83="" id="app">
    <div data-v-95c8bc32="" data-v-676ecf83="" class="header2">
        <div data-v-95c8bc32="" class="layout clear">
            ...
            <a data-v-95c8bc32="" href="../index.html" class="right">回到首页&gt;</a>
        </div>
    </div>
                ...
                <div data-v-676ecf83="" class="registerType left">
                    ...
                    <form class="layui-form" method="post">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input type="password" name="password" lay-verify="password" placeholder="请输入6-12位密码" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input type="repassword" lay-verify="repassword" placeholder="请再次输入密码" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input type="text" name="email" lay-verify="email" placeholder="请输入电子邮箱，用于登录和找回密码" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input type="text" name="invitation" lay-verify="invitation" autocomplete="off" placeholder="如有邀请码，请填写邀请码" class="layui-input">
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
