        ...
        <div data-v-67ef3a4a class="layout clear">
            <div data-v-67ef3a4a class="left csdnav">
                <label data-v-67ef3a4a>
                    <a data-v-67ef3a4a href="/login.jsp" class="colorRed">登录</a>
                    <a data-v-67ef3a4a href="javascript:void" class="colorRed">/</a>
                    <a data-v-67ef3a4a href="/register.jsp" class="colorRed" style="margin-right: 10px;">注册</a>
                </label>
        ...
        <div data-v-39f7f629="" class="layout clear">
            ...
            <div data-v-39f7f629="" class="left navCom">
                <ul data-v-39f7f629="">
                    ...
                    <li data-v-39f7f629="">
                        <a data-v-39f7f629="" href="login.jsp" target="_self" class="">短租自驾</a>
                    </li>
                    <li data-v-39f7f629="">
