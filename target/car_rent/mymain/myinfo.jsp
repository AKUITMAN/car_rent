...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="../css/mymain.mymain.css">
    ...
    <div data-v-95ac8d30="" class="header3">
        <div data-v-95ac8d30="" class="layout clear">
            ...
            <div data-v-95ac8d30="" class="header3User right">
                ...
                <span data-v-95ac8d30="" class="sp2">欢迎您，${sessionScope.tel.tel}</span>
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if(data.code==1){
                    ...
                    vm.password=data.data.password;
                }
            }
        });
    })
        ...
        var active = {
            ...
            ,offset: function(othis){
                ...
                layer.open({
                    ...
                    ,content: '<div style="width: 300px; height: 200px;">请输入修改后的手机号：<br>' +
                        '<form>' +
                        'tel:<input type="text" name="tel" id="tel"><br>email:<input type="email" name="email" id="email"><br>password:<input type="password" name="password" id="password"> ' +
                        '</form></div>'
                    ,btn: '修改'
                    ,btnAlign: 'c' //按钮居中
                    ,shade: 0 //不显示遮罩
